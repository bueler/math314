...
\prob{P47} from 4.4: check that this 3x3 matrix $Z$ is orthogonal by (1) dot products of columns, (2) $Z^\top Z = I$, and observe these are the same calculations
...
det(orthogonal) = +-1: example, show generally
