...
\usepackage[top=1.0in, bottom=0.3in, left=0.9in, right=1.0in]{geometry}
...
\wkday{14}{4/11}{4/15} & 6.2 & \dots & \emph{(6.3)} \par \due{HW11} \\ \hline

\wkday{15}{4/18}{4/22} & 6.4 & 8.1 \par \phantom{foo} & 8.2 \\ \hline

\wkday{16}{4/25}{4/29} & \vac{no class} \par \due{HW12} & \vac{no class} \par Review Session \par 4:30--6:00 Chap 104 & \ee{Final Exam} \par \ee{8:00--10:00} \\ \hline
